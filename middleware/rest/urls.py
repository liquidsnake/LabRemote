...
urlpatterns = patterns('',
    ...
    (r'group/(?P<course>\d+)/(?P<user>\d+)/(?P<session_key>\w+)/(?P<name>[^/]+)/(?P<activity_id>\d+)/(?P<week>\d+)/', views.group),
    (r'group/(?P<course>\d+)/(?P<user>\d+)/(?P<session_key>\w+)/(?P<name>[^/]+)/(?P<activity_id>\d+)/', views.group),
    (r'current_group/(?P<course>\d+)/(?P<user>\d+)/(?P<session_key>\w+)/(?P<week>\d+)/', views.current_group),
    (r'current_group/(?P<course>\d+)/(?P<user>\d+)/(?P<session_key>\w+)/', views.current_group),
